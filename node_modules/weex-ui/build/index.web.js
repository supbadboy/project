  ...
  return _c('div', {
    ...
    return _c('section', {
      ...
      return _c('div', {
        ...
        staticClass: " weex-ct weex-div",
        class: ['row-item', cell.cellClass],
        style: (_vm._px2rem(cell.isSelected ? _vm.selectedCellStyle : {}, 75)),
        attrs: {
          "accessible": true,
          "aria-label": ((cell.text?cell.text:'') + "," + (cell.note?cell.note:'') + "," + (cell.ext?cell.ext:'')),
          "weex-type": "div",
        ...
        style: (_vm._processExclusiveStyle(cell.isSelected ? _vm.selectedTextStyle : {}, 75, 'text')),
        attrs: {
          "weex-type": "text"
        }
